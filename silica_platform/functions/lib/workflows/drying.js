...
exports.handleDryingUpdate = handleDryingUpdate;
const admin = __importStar(require("firebase-admin"));
const fcm_1 = require("../fcm");
async function handleDryingUpdate(ticketId, before, after) {
    ...
    if (qc?.status === 'Pass' && qc?.grade && after?.bed) {
        ...
        await (0, fcm_1.notifyRoles)(['Manager', 'QC'], 'AFS Ready Stock Updated', `Bed ${after.bed}, Grade ${qc.grade}`);
    }
}
